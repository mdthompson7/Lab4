...
public class Colosseum {
    ...
    /**
     * The maximum attack we will allow a Pokemon to start with.
     */
    static final int MAX_ATTACK_VAL = 49;
    /**
     * The minimum attack we will allow a Pokemon to start with.
     */
    static final int MIN_ATTACK_VAL = 1;
    /**
     * The maximum defense we will allow a Pokemon to start with.
     */
    static final int MAX_DEFENSE_VAL = 49;
    /**
     * The minimum defense we will allow a Pokemon to start with.
     */
    static final int MIN_DEFENSE_VAL = 1;
    /**
     * The maximum number of rounds we will let the Pokemon battle.
     */
    static final int MAX_NUM_ROUNDS = 100;
    ...
    public static Pokemon buildPokemon() {
        ...
        while (tempPokemon.hitPoints == 0) {
            System.out.println("How much health will it have, between 1 and 50?");
            tempPokemon.hitPoints = myScan.nextInt();
            if (tempPokemon.hitPoints > MAX_HIT_POINTS || tempPokemon.hitPoints < MIN_HIT_POINTS) {
                System.out.println("Sorry. Hit points must be between 1 and 50.");
                tempPokemon.hitPoints = 0;
            }
        }
        System.out.println("Split 50 points between your attack and defense.");
        while (tempPokemon.attackLevel == 0) {
            System.out.println("Attack Level:");
            tempPokemon.attackLevel = myScan.nextInt();
            if (tempPokemon.attackLevel > MAX_ATTACK_VAL
                    || tempPokemon.attackLevel < MIN_ATTACK_VAL) {
        ...
        while (tempPokemon.defenseLevel == 0) {
            ...
            if (tempPokemon.defenseLevel > (MAX_ATTACK_VAL - tempPokemon.attackLevel + 1)
                    || tempPokemon.defenseLevel < MIN_DEFENSE_VAL) {
                System.out.println("Sorry. The attack level must be between 1 and " + (MAX_DEFENSE_VAL - tempPokemon.attackLevel + 1) + ".");
                tempPokemon.defenseLevel = 0;
            }
        }
